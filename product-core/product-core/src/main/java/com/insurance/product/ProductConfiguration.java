...
@PropertySource(name = "com.insurance.product", value = "classpath:/com/insurance/product/module.properties")
public class ProductConfiguration {

    @Bean("product_ProductViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.insurance.product"));
        return viewControllers;
    }

    @Bean("product_ProductActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.insurance.product"));
        return actions;
    }
}
